...
class MyFileApp extends StatefulWidget {
  @override
  _MyFileAppState createState() => _MyFileAppState();

  static _MyFileAppState of(BuildContext context) {
    return context.findAncestorStateOfType<_MyFileAppState>();
  }
}

class _MyFileAppState extends State<MyFileApp> {
...
class _DemoPageState extends State<DemoPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final appState = MyFileApp.of(context);
